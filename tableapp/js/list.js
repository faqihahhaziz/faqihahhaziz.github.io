...
function GetBooking() {
    let url = 'https://api.sheety.co/ae02c4c5b9ec492d9070b7a6411980c2/bookingApp/bookings';
    fetch(url)
...
function DeleteBooking(id) {
    let url = 'https://api.sheety.co/ae02c4c5b9ec492d9070b7a6411980c2/bookingApp/bookings/' + id;
    fetch(url, {
        method: 'DELETE',
    })
